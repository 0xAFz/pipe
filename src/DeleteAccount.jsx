...
function DeleteAccount() {
    ...
    return (
        <>
            <div class="border border-zinc-700 px-4 py-4 rounded mx-auto max-w-md flex justify-center flex-col gap-3">
                ...
                <div class="mt-8 max-w-md mx-auto flex items-center justify-center rounded px-8 py-8 gap-4">
                    <button onClick={handleDeleteAccount} type="button" class="flex flex-row-reverse items-center gap-2 px-10 py-2 text-center bg-red-500 text-white rounded-md">
                        حذف
                    </button>

                    <A href="/me" class="flex flex-row-reverse items-center gap-2 px-10 py-2 text-center bg-slate-200 text-black rounded-md">
                        بیخیال
                    </A>
                </div>
            </div>
